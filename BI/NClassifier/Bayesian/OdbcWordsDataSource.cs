...
namespace NClassifier.Bayesian
{
	public class OdbcWordsDataSource : ICategorizedWordsDataSource
	{
        ...
        public WordProbability GetWordProbability(Categories category, string word)
		{
        ...
        private void UpdateWordProbability(Categories category, string word, bool isMatch)
		{
        ...
        public void AddMatch(Categories category, string word)
		{
			if (category == null)
        ...
        public void AddNonMatch(Categories category, string word)
		{
			if (category == null)
				throw new ArgumentNullException("Category cannot be null.");
