...
namespace NClassifier.Bayesian
{
	...
	public class WordProbability : IComparable
	{
        ...
        public WordProbability(iRocks.DataLayer.WordProbability aWordProbability)
        {
            this._word = aWordProbability.Word;
		this._categoryId = aWordProbability.CategoryId;
		this._matchingCount = aWordProbability.Matches;
		this._nonMatchingCount = aWordProbability.NonMatches;
		...
		public int CompareTo(object obj)
		{
			...
			if (this.CategoryId != rhs.CategoryId)
